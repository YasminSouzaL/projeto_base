...
<?php
  ...
  //echo "<script>alert('Olá Administrador!');window.location.href='http://localhost/Projeto/sistema_cadastra2/menu_1.php';</script>;
  echo "<div id='msg_sucesso2'>";
  echo"Bem-Vindo,$login_cookie <br>";
  echo"<br> Para melhor usar nosso site faça o login:";
  echo "<a href='http://localhost/Nova%20pasta/sistema_cadastra2/login.html'>LOGIN</a>";
  echo "</div>";
  $id=4; 
    ...
    break;
      case 4:
          ...
          alert('Ola Alunos');window.location.href='menu_1.php';</script>";
      break;          
    }
